 ...
 * the License.
 */
package com.jason.liu.mybatisplus.generator.engine;

import com.baomidou.mybatisplus.core.toolkit.CollectionUtils;
import com.baomidou.mybatisplus.core.toolkit.StringPool;
import com.baomidou.mybatisplus.core.toolkit.StringUtils;
import com.jason.liu.mybatisplus.generator.InjectionConfig;
import com.jason.liu.mybatisplus.generator.config.ConstVal;
import com.jason.liu.mybatisplus.generator.config.FileOutConfig;
import com.jason.liu.mybatisplus.generator.config.GlobalConfig;
import com.jason.liu.mybatisplus.generator.config.TemplateConfig;
import com.jason.liu.mybatisplus.generator.config.builder.ConfigBuilder;
import com.jason.liu.mybatisplus.generator.config.po.TableInfo;
import com.jason.liu.mybatisplus.generator.config.rules.FileType;
...
public abstract class AbstractTemplateEngine {
    ...
    public Map<String, Object> getObjectMap(TableInfo tableInfo) {
        ...
        objectMap.put("superEntityInterfaces", getSuperClassNames(config.getSuperEntityInterfaces()));
        ...
        objectMap.put("dataSourceName", globalConfig.getDataSourceName());
        objectMap.put("dataSourceEnabled", globalConfig.getDataSourceEnabled());
     ...
     * 获取类名
     *
     * @param classPaths ignore
     * @return ignore
     */
    private String[] getSuperClassNames(List<String> classPaths) {
        if (CollectionUtils.isEmpty(classPaths)) {
            return null;
        }
        return classPaths.stream().map(path -> path.substring(path.lastIndexOf(StringPool.DOT) + 1)).collect(Collectors.toList()).toArray(new String[]{});
    }
