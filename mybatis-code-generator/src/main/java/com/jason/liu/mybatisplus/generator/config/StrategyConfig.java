 ...
 * the License.
 */
package com.jason.liu.mybatisplus.generator.config;

import com.baomidou.mybatisplus.core.metadata.TableInfoHelper;
import com.baomidou.mybatisplus.core.toolkit.ClassUtils;
import com.baomidou.mybatisplus.core.toolkit.StringUtils;
import com.jason.liu.mybatisplus.generator.config.po.LikeTable;
...
public class StrategyConfig {
     ...
     * @return
     */
    public StrategyConfig setSuperEntityInterface(Class<?> clazz) {
        return setSuperEntityInterfaces(clazz, null);
    }
     ...
     * @return
     */
    public StrategyConfig setSuperEntityInterfaces(Class<?> clazz, NamingStrategy columnNaming) {
        if (null != columnNaming) {
            this.columnNaming = columnNaming;
        }
        if (null == this.superEntityInterfaces) {
            this.superEntityInterfaces = new ArrayList<>();
        }
        this.superEntityInterfaces.add(clazz.getName());
        return this;
    }
