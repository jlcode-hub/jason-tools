 ...
 * the License.
 */
package com.jason.liu.mybatisplus.generator.config.builder;
...
import com.jason.liu.mybatisplus.generator.config.po.TableFill;
import com.jason.liu.mybatisplus.generator.config.po.TableInfo;
import com.jason.liu.mybatisplus.generator.config.querys.H2Query;
...
public class ConfigBuilder {
    ...
    private List<String> superEntityInterfaces;
    ...
    public List<String> getSuperEntityInterfaces() {
        return superEntityInterfaces;
    }
    ...
    private void processTypes(StrategyConfig config) {
        ...
        superEntityInterfaces = config.getSuperEntityInterfaces();
    ...
    private void checkImportPackages(TableInfo tableInfo) {
        ...
        if (CollectionUtils.isNotEmpty(strategyConfig.getSuperEntityInterfaces())) {
            for (String superEntityInterface : strategyConfig.getSuperEntityInterfaces()) {
                tableInfo.getImportPackages().add(superEntityInterface);
            }
        }
        ...
        try {
            ...
            try (
                ...
                while (results.next()) {
                    ...
                    field.setColumnType(dataSourceConfig.getTypeConvert().processTypeConvert(globalConfig, tableInfo, field));
                    if (commentSupported) {
