 ...
 * the License.
 */
package com.jason.liu.mybatisplus.generator;
...
import com.jason.liu.mybatisplus.generator.engine.AbstractTemplateEngine;
...
public class AutoGenerator {
    ...
    protected ConfigBuilder pretreatmentConfigBuilder(ConfigBuilder config) {
        ...
        for (TableInfo tableInfo : tableList) {
            ...
            if (CollectionUtils.isNotEmpty(config.getSuperEntityInterfaces())) {
                // 父接口
                for (String superEntityInterface : config.getSuperEntityInterfaces()) {
                    tableInfo.setImportPackages(superEntityInterface);
                }
            }
            if (config.getGlobalConfig().isActiveRecord()) {
